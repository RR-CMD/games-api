    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth.requestMatchers("/auth/**", "/v3/api-docs/**", "/swagger-ui/**",
                        ...
                        .permitAll()
                        .requestMatchers(HttpMethod.GET, "/reviews/game/**")
                        .permitAll()
                        .requestMatchers(HttpMethod.GET, "/reviews/user/**")
                        .permitAll()
                        .requestMatchers(HttpMethod.GET, "/user-games/user/**")
                        .permitAll()
                        .requestMatchers(HttpMethod.GET, "/user-games/*/stats")
                        .permitAll()
